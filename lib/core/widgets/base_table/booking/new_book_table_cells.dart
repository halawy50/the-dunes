...
class NewBookTableCells {
  ...
  static Widget buildAgent(
    ...
    int index,
    NewBookingCubit cubit,
  ) => NewBookDropdowns.buildAgentDropdown(context, row, index, cubit);
  ...
  static Widget buildHotel(
    ...
    int index,
    NewBookingCubit cubit,
  ) => NewBookDropdowns.buildHotelDropdown(context, row, index, cubit);
  ...
  static Widget buildDriver(
    ...
    int index,
    NewBookingCubit cubit,
  ) => NewBookDropdowns.buildDriverDropdown(context, row, index, cubit);
  ...
  static Widget buildDiscount(
    ...
    NewBookingCubit cubit,
        ...
        value: row.discount.toStringAsFixed(0),
